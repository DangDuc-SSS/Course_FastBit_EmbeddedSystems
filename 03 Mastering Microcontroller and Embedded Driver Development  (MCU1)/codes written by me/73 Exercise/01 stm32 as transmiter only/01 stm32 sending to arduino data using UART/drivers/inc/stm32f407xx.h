...
#define SYS_CFG						((SYSCFG_RegDef_t*)SYSCFG_BASEADDR)
...
/*
 * Macros to reset for SPIOx Peripherals
 */
...
/*
 * Macros to reset for I2Cx Peripherals
 */
...
/*
 * Macros to reset for USARTx Peripherals
 */
