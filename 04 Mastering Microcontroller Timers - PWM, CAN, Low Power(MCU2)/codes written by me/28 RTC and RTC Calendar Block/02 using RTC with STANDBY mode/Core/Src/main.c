...
int main(void)
{
	...
	// this line to be executed only once and then comment it out and upload the code again to the uc and you
	// will see that the contents of RTC aren't changed with reset
	//RTC_CalendarConfig();
